...
/**
 * print_octal_number - print an unsigned number in octal notation
 ...
 */
int print_octal_number(va_list types, char buffer[], int flag,
...
/**
 * print_hupper_number - print an unsigned number in upper hexa notation
 * @types: lista of arguments
 * @buffer: buffer array to handle print
 * @flag: calculates active flags
 * @width: get width
 ...
 * Return: number of char printed
 */
int print_hupper_number(va_list types, char buffer[], int flag,
int width, int prec, int size)
{
	return (print_hexa(types, "0123456789ABCDEF", buffer, flag,
	'X', width, prec, size));
}

/* UNSIGNED NUMBER IN HEXADECIMAL */
/**
 * print_hexadecimal_number - print an unsigned number in hexa notation
 * @types: lista of arguments
 * @buffer: buffer array to handle print
 * @flag: calculates active flags
 * @width: get width
 ...
 * Return: number of char printed
 */
int print_hexadecimal_number(va_list types, char buffer[], int flag,
int width, int prec, int size)
{
	return (print_hexa(types, "0123456789abcdef", buffer, flag,
	'x', width, prec, size));
 ...
 * Return: number of char printed
 */
int print_hexa_number(va_list types, char map_to[], char buffer[], int flag,
