...
/*************************PRINT POINTER****************************/
/**
 * print_pointer - print vale of pointer variable
...
int width, int precision, int size)
{
	...
	padd, extre_c, padd_start));
}

/********************* PRINT NON PRINTABLE ****************************/

/**
 * print_non_printable - print non printable variable
 * @types: lista of arguments
 * @buffer: buffer array to handle print
 * @flags: calculates active flags
 * @width: get width
...
int width, int precision, int size)
{
	...
	unsigned int i, t;
	int count = 0;
	char in[] = "ABCDEFJHIJKLMNOPQRSTUVWXYZabcdefjhijklmnopqrstuvwxyz";
	char out[] = "NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxrzabcdefghijklm";
